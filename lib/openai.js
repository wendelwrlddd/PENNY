...
export async function extractFinancialData(messageText, userData = {}, isBrazil = false) {
  ...
  - **LANGUAGE RULE:** You operate primarily in ENGLISH. 
    However, if the variable "IS_BRAZIL" is TRUE, you MUST generate the "response_message" in **PORTUGUESE (PT-BR)**.
  ...
  **CASE B: SAVINGS/SURPLUS (Balance > Income)**
  ...
  User: "Sitting on 5k" (Context: Income was 3000)
  JSON: { "intent": "SET_CURRENT_BALANCE", "balance_change": 2000, "next_question": null, "response_message": "..." }
  
  User: "I'm broke" (Context: Income 3000)
  JSON: { "intent": "SET_CURRENT_BALANCE", "adjustment_expense": 3000, "next_question": null, "response_message": "..." }
  `;

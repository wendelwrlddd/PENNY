...
RESET RULES:
- Messages like "reset profile", "resetar meu perfil", "apagar meus dados", "clear data" indicate RESET.
- The response_message should confirm the data will be cleared.
...
JSON SCHEMA:
{
  "intent": "ADD_EXPENSE | MULTIPLE_EXPENSES | SET_MONTHLY_INCOME | SET_PAYDAY | SET_CURRENT_BALANCE | CORRECTION | RESET | NO_ACTION",
  "expenses": [

...
export async function extractFinancialData(messageText, userData = {}, isBrazil = false) {
  ...
  **CASE 1: USER IS NEW (onboarding_step != "ACTIVE")**
  ...
  - **IF onboarding_step is "ASK_BALANCE":**
    ...
    - Case A (Balance < Income): (PT): "Entendido. Registrei R$[Diff] como gastos anteriores para bater com seu saldo atual. 💸"
    - Case B (Balance > Income): (PT): "Boa! Adicionei R$[Diff] como economia extra. Seu saldo total agora é R$[Balance]. 💰"
  ...
  **CASE 2: USER IS ACTIVE (onboarding_step == "ACTIVE")**
  ...
  JSON: {
    ...
    "next_question": null,
    "response_message": "Entendido. Registrei R$1000 como gastos anteriores para bater com seu saldo atual. 💸"
  }
  `;

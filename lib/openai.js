...
export async function extractFinancialData(messageText, userData = {}, isBrazil = false, currentObjective = 'ACTIVE') {
  ...
  - GOAL: Identify how the user receives income.
  - VALID TYPES: "hourly", "weekly", "biweekly", "monthly".
  - ACTION: If the user picks one, return SET_INCOME_TYPE with income_type.
  - RESPONSE: Confirm and welcome them. If they didn't pick, politely ask: "How do you receive your income? 1️⃣ Hourly, 2️⃣ Weekly, 3️⃣ Fortnightly, 4️⃣ Monthly"
  ` : ''}

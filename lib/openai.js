...
export async function extractFinancialData(messageText, userData = {}, isBrazil = false) {
  ...
  * No mês: R$[Total Month + Amount]
  ...
  ════════════════════════════
  You must check the "onboarding_step" variable BEFORE deciding the intent.
  A raw number (e.g., "1500") must be interpreted based on the current step.

  **CASE 1: USER IS NEW (onboarding_step != "ACTIVE")**
  
  - **IF onboarding_step is "ASK_INCOME" (or null/initial):**
    - A raw number or message about income MUST trigger "SET_MONTHLY_INCOME".
    - Action: Save income (monthly_income).
    - Response Format: (PT): "Perfeito! Anotei sua renda 💵. Para calibrar: quanto você tem de saldo disponível agora?" | (EN): "Perfect! I've noted your income 💵. To calibrate: how much total money do you have available right now?"
    - Set JSON: "next_question": "ASK_BALANCE"

  - **IF onboarding_step is "ASK_BALANCE":**
    - A raw number or message about balance MUST trigger "SET_CURRENT_BALANCE".
    - Action: Record balance and perform Reconciliation (Math).
    - Math: Diff = ABS(Income - Balance).
    - **Case A (Balance < Income):** 
      (PT): "Entendido! Registrei R$[Diff] como gastos anteriores para bater com seu saldo inicial. 💸\n\n✅ *Perfil configurado!* Seu Dashboard está pronto: ${userData.dashboard_link} 🚀\n\nContinue me enviando seus gastos para mantermos tudo sob controle! 📈" 
      (EN): "Got it! I've recorded $[Diff] as previous expenses to match your initial balance. 💸\n\n✅ *Profile ready!* Your Dashboard is live: ${userData.dashboard_link} 🚀\n\nKeep sending me your expenses to stay on track! 📈"
    - **Case B (Balance > Income or Equal):** 
      (PT): "Boa! Adicionei R$[Diff] como economia extra. Seu saldo total agora é R$[Balance]. 💰\n\n✅ *Perfil configurado!* Seu Dashboard está pronto: ${userData.dashboard_link} 🚀\n\nContinue me enviando seus gastos para mantermos tudo sob controle! 📈"
      (EN): "Awesome! I've added $[Diff] as extra savings. Your total balance is now $[Balance]. 💰\n\n✅ *Profile ready!* Your Dashboard is live: ${userData.dashboard_link} 🚀\n\nKeep sending me your expenses to stay on track! 📈"
  ...
  **CASE 2: USER IS ACTIVE (onboarding_step == "ACTIVE")**
  ...
  User: "1400" (State: ASK_INCOME, isBrazil: true)
  JSON: {
    "intent": "SET_MONTHLY_INCOME",
    "monthly_income": 1400,
    "next_question": "ASK_BALANCE",
    "response_message": "Perfeito! Anotei sua renda 💵. Para calibrar: quanto você tem de saldo disponível agora?"
  }

  User: "1600" (State: ASK_BALANCE, Income: 1400, isBrazil: true)
  JSON: {
    "intent": "SET_CURRENT_BALANCE",
    "balance_change": 200,
    "next_question": null,
    "response_message": "Boa! Adicionei R$200 como economia extra. Seu saldo total agora é R$1600. 💰\n\n✅ *Perfil configurado!* Seu Dashboard está pronto: ${userData.dashboard_link} 🚀\n\nContinue me enviando seus gastos para mantermos tudo sob controle! 📈"
  }
  `;

...
export async function extractFinancialData(messageText, userData = {}, isBrazil = false, currentObjective = 'ACTIVE') {
  ...
  - RULES: If user says anything else (or just "hi"), YOU MUST REPEAT THE QUESTION: "Hi! I’ll quickly set things up. How do you receive your income? 1️⃣ Hourly, 2️⃣ Weekly, 3️⃣ Fortnightly, 4️⃣ Monthly / Contract"

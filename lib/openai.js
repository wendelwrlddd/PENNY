...
════════════════════════════
You MUST classify every expense into one of these EXACT categories (return the ENGLISH KEY in the JSON):
- Food (Alimentação, markets, restaurants, snacks)
- Transport (Fuel, uber, bus, parking)
- Shopping (Clothes, electronics, general items)
- Leisure (Cinema, trips, parties, hobbies)
- Bills (Rent, electricity, water, internet, insurance)
- General (Miscellaneous, unexpected costs)

SPECIAL RULE FOR TRANSFERS/PIX:
Analyze the context:
- "Pix no mercado" -> Food
- "Pix do aluguel" -> Bills
- "Transferência uber" -> Transport
- "Pagamento internet" -> Bills
If the context is unclear, use "General".
...
Schema:
{
  ...
  "amount": number | null,
  "category": "Food | Transport | Shopping | Leisure | Bills | General",

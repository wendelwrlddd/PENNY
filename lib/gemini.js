      ...
      while (retryCount <= maxRetries) {
        try {
          ...
          const prompt = `Extract financial data or user profile info from this message: "${messageText}". 
                          ...
                          - UNCERTAIN: If the message is confusing, incomplete, or contains typos (e.g., "minha so 181").
                          ...
                          4. If intent is UNCERTAIN:
                             - Provide a "suggestion" field in English of what you think the user meant (e.g., "I have 181 left").
